...
const contractABI = require("../artifacts/contracts/Powerampforge.sol/Powerampforge.json").abi;

program
    .name("powerampforge-cli")
    .description("CLI tool for Powerampforge smart contract")
    .version("1.0.0");
