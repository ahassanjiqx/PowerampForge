 ...
 * This file demonstrates how to integrate Powerampforge with a web frontend
 */

// For React/Vue/Angular applications
export class PowerampforgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new PowerampforgeClient(provider, contractAddress);
